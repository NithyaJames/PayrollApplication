...
public class ExtenetReport implements ITestListener {
	...
	public void configureReport() {
		...
		reports.setSystemInfo("Project", "PayRollApplication");
		reports.setSystemInfo("PC Name", "Nithya's PC");
		reports.setSystemInfo("OS", "Windows 11");
		reports.setSystemInfo("Test Done By", "Nithya James");		
		sparkReporter.config().setDocumentTitle("PayRollApplication Report ");
		sparkReporter.config().setReportName("Report Summary");
		sparkReporter.config().setTheme(Theme.STANDARD);  // DARK for dark view
	}
	...
	public void onFinish(ITestContext context) {
		reports.flush();   //To generate the report,without this report wont get generate
	}
